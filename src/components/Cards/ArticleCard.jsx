  ...
  return (
    <Card sx={{ maxWidth: 345, width: "32%" }}>
      <CardActionArea>
        ...
        {/* Extra small screens */}
        <CardContent
          sx={{ display: { xs: "block", sm: "none", padding: "0px 10px" } }}
        >
          <Typography gutterBottom variant="body2" component="div">
            <span style={{ color: "secondary.gray", fontSize: "1.2vw" }}>
              {data.category}
            </span>{" "}
            <span style={{ color: "secondary.lightGray", fontSize: "1.8vw" }}>
              |
            </span>{" "}
            <span style={{ color: "secondary.gray", fontSize: "1.2vw" }}>
          ...
          <Typography
            variant="body1"
            sx={{ color: "primary.dark", fontSize: "1.6vw" }}
          >
            {data.title}
          </Typography>
        ...
        <CardContent sx={{ display: { xs: "none", sm: "block", md: "none" } }}>
          <Typography gutterBottom variant="body2" component="div">
            <span style={{ color: "secondary.gray", fontSize: "1.5vw" }}>
              {data.category}
            </span>{" "}
            <span style={{ color: "secondary.lightGray", fontSize: "1.8vw" }}>
              |
          ...
          <Typography
            variant="body1"
            sx={{ color: "primary.dark", fontSize: "2vw" }}
          >
            {data.title}
          </Typography>
          <Box sx={{ display: "flex", alignItems: "center", gap: "3px" }}>
        ...
        <CardContent sx={{ display: { xs: "none", md: "block" } }}>
          <Typography gutterBottom variant="body2" component="div">
            ...
            <span style={{ color: "secondary.gray" }}>
              {dateConvertor(data.date)}
            </span>
          </Typography>
