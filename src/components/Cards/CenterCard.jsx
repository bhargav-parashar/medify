  ...
  return (
    ...
    >
      ...
      >
        ...
        >{`${data["Hospital Type"].toLowerCase()}, ${data["Address"].toLowerCase()}, ${data["ZIP Code"]}.`}</Typography>
      ...
      >
        <Typography
           sx={{ textTransform: "capitalize", fontSize: "1vw", lineHeight:1, color: "#00A500", fontWeight:"bold" }}
        >
          Available Today
        </Typography>
